...
import AdminBikesPage from './pages/admin/bikes/AdminBikesPage';
import BikeProfilePage from './pages/admin/bikes/BikeProfilePage';
import { AdminBookings, AdminInventory, AdminReports, AdminProfile } from './pages/admin/AdminPlaceholders';
            ...
            <MechanicProvider>
              <BikeProvider>
                <Routes>
                  ...
                  {/* ── Auth ───────────────────────────────────────── */}
                  <Route path="/login/admin font" element={<AdminLoginPage />} />
                  ...
                  <Route path="/admin/bikes"     element={<ProtectedRoute requiredRole="admin"><AdminBikesPage /></ProtectedRoute>} />
                  <Route path="/admin/bikes/:id" element={<ProtectedRoute requiredRole="admin"><BikeProfilePage /></ProtectedRoute>} />
                  <Route path="/admin/vehicles font" element={<Navigate to="/admin/bikes" replace />} />
                  <Route path="/admin/vehicles"  element={<Navigate to="/admin/bikes" replace />} />
